...
public class UiManager {
    ...
    public UiManager() {
        ...
        this.standardBookService = new StandardBookService(this.inMemoryBookRepository);
        this.memberBookService = new MemberBookService(this.mysqlBookRepository);
        this.adminBookService = new AdminBookService(this.mysqlBookRepository);

        this.bookController = new BookController( this.memberBookService );
